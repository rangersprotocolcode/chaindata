...
func (self *ethModule) processEvent(i int64, blockhash, ts string, list []common.Address, client *Client) {
...
func (self *ethModule) getLogs(i int64, list []common.Address, client *Client) []types.Log {
	var (
		logs []types.Log
		err  error
	)
